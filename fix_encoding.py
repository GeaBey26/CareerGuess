...
translations_code = """const TRANSLATIONS = {
    tr: {
...
with open('c:/Users/Monster/OneDrive/Masaüstü/Antrigravitiy WS/script.js', 'r', encoding='utf-8', errors='ignore') as f:
    lines = f.readlines()

# Find setLanguage end line
# It ends at line 572 in my previous view_file
# But let's find it by content
end_idx = -1
for i, line in enumerate(lines):
    if 'showLeaderboard()' in line:
        end_idx = i
        break

if end_idx != -1:
    # Start of TRANSLATIONS is line 154 (0-indexed 153)
    # But let's find it too
    start_idx = -1
    for i, line in enumerate(lines):
    ...
    if start_idx != -1:
        new_lines = lines[:start_idx] + [translations_code + '\n'] + lines[end_idx:]
        with open('c:/Users/Monster/OneDrive/Masaüstü/Antrigravitiy WS/script.js', 'w', encoding='utf-8') as f:
